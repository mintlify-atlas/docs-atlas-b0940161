...
<ParamField body="products" type="array" required>
  ...
  <Expandable title="Product Object">
    ...
    <ParamField body="type" type="string" required>
      ...
      - `BEVERAGE` - Routed to BAR station
      - `HOT_FOOD` - Routed to HOT_KITCHEN station
      - `COLD_FOOD` - Routed to COLD_KITCHEN station
    </ParamField>
  </Expandable>
</ParamField>
...
|--------------|---------|------------------|
| `BEVERAGE` | BAR | Coffee, Tea, Juice, Cocktails |
| `HOT_FOOD` | HOT_KITCHEN | Grilled items, Pasta, Steak |
| `COLD_FOOD` | COLD_KITCHEN | Salads, Desserts, Cold appetizers |